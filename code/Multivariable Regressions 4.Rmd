---
title: "Multivariable Regressions 4"
author: "Anshu Uppal"
...
**Main exposure:** `wfh_updated` categorized into five groups ("Never", "Not possible", "Occasionally (irregular)", "1+ days/week", "Every day")  
...
mcovariates <- c("wfh_updated", "wfh_change",
                 "age_cat","sex_en","education_rec_en",
                  "hh_income_cat_en", "finance_situation", "supervision_short", # which variable to use for financial security? or too linked with income?
...
```{r}
ggplotly( dat %>% 
  ggplot(aes(x = physical_interaction, y = social_interaction, color = wfh_updated, label = paste(profession.y, "\n", Occupation_label)))+
  geom_point()+
